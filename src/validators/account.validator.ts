...
export const CreateAccountRequestValidator = createRequestValidator({ body: CreateAccountSchema });
export const UpdateAccountRequestValidator = createRequestValidator({
  params: idDtoSchema,
  body: UpdateAccountSchema,
});
export const GetAccountRequestValidator = createRequestValidator({ params: idDtoSchema });
export const DeleteAccountRequestValidator = createRequestValidator({ params: idDtoSchema });
export const ListAccountsRequestValidator = createRequestValidator({
